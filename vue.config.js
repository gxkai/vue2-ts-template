...
const DEVELOPMENT = webpackConfig => {
  /**
   * @description 启用 eval-source-map 更好的测试
...
const PRODUCTION = webpackConfig => {
  /**
   * @description 不需要启用 source-map，去除 console 的情况下 source-map 根本没用，还浪费大量时间和空间
...
module.exports = {
  ...
  pluginOptions: {
    ...
    "style-resources-loader": {
      preProcessor: "less",
      patterns: [
        path.resolve(__dirname, "./src/styles/variables/index.less"),
